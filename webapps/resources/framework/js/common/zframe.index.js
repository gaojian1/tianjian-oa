...
function showChangeInfo(){
	...
	if(!top.Home.showChangeInfo){
		winShowChangeInfo.windows({
			title:"修改个人信息",
			width:800,
			height:200,
			modal:true,
			...
			closed:false,
			iconCls:'icon-key',
			href:top.Home.BasePath+"/admin/user/editNew"
		});
		top.Home.showChangeInfo  = winShowChangeInfo;
	}else{
		winShowChangeInfo.open();
	}
