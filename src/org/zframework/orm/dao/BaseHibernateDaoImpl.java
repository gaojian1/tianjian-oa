...
public class BaseHibernateDaoImpl extends BaseHibernateDao{
	 ...
	 * 添加别名
	 */
	public void addAlias(Class clazz,Criteria criteria){
		try {
			if(clazz.newInstance() instanceof Signuserrole){
				criteria.createAlias("user", "user");
				criteria.createAlias("signrole", "signrole");
			}
		} catch (Exception e) {
